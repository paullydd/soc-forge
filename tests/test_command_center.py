...
@pytest.mark.parametrize(
    ...
    [
        ("detection", "detection_menu", "DETECTION", (None,) * 7, ("1", "2", "3", "4", "5", "0")),
        ("investigations", "investigations_menu", "INVESTIGATIONS", (None,) * 8, ("1", "2", "3", "4", "5", "6", "0")),
        ("analysis", "analysis_menu", "ANALYSIS", (None,) * 3, ("1", "2", "3", "4", "0")),
        ("reporting", "reporting_menu", "REPORTING", (None,) * 4, ("1", "2", "3", "0")),
        ("system", "system_menu", "SYSTEM", (None,) * 3, ("1", "2", "0")),
    ],
)

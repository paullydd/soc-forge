...
def test_workspace_grouped_navigation_preserves_locked_numbers():
    assert INVESTIGATION_WORKSPACE_GROUPS == (
        ("ANALYSIS", (("1", "Investigation Summary"), ("10", "Evidence Workspace"), ("11", "Hypotheses and Decisions"), ("12", "Investigation Findings"), ("13", "Timeline and Pivot Workbench (Read Only)"), ("17", "Investigation Replay (Read Only)"), ("18", "Entity Relationship Explorer (Read Only)"))),

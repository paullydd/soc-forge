...
SOC-Forge v3.6 Reporting is a read-only delivery workspace built from existing authoritative state. It does not introduce a report registry, a second operations model, persistence, mutation, AI-generated conclusions, or remediation execution.

...
def main():
    ...
    ap.add_argument("--format", default=None, choices=["jsonl", "windows-security-csv", "windows-security-evtx", "evtx", "linux-auth-log", "linux-auditd", "nginx-access-log"], help="Input format override; defaults to auto-detect from file extension (linux-auth-log, linux-auditd, and nginx-access-log have no auto-detected extension and must be passed explicitly)")
